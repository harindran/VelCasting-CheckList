...
#Region "Menu Creation Details"
        ...
        Private Sub Menu()
            ...
            Menucount = 12
            CreateMenu("", Menucount, "Grade Master", SAPbouiCOM.BoMenuType.mt_STRING, "GRDMSTR", "4352") : Menucount += 1 ' "43537"
                ...
                If pVal.BeforeAction Then
                    Select Case pVal.EventType
                        Case SAPbouiCOM.BoEventTypes.et_CLICK
                            If bModal And objaddon.objapplication.Forms.ActiveForm.TypeEx = "65214" Then
                                BubbleEvent = False
                                objapplication.Forms.Item("MICKLT").Select()
                            End If
                        Case SAPbouiCOM.BoEventTypes.et_FORM_CLOSE
                            Dim EventEnum As SAPbouiCOM.BoEventTypes
                            EventEnum = pVal.EventType
                            If FormUID = "MICKLT" And (EventEnum = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) And bModal Then
                                bModal = False
